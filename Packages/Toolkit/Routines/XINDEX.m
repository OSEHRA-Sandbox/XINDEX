XINDEX ;ISC/REL,GFT,GRK,RWF - INDEX & CROSS-REFERENCE ;MAY 30 2018
 ;;7.3;TOOLKIT;**20,27,48,61,66,68,110,121,128,132,133,10001**;Apr 25, 1995;Build 15
...
LOAD S X=RTN,XCNP=0,DIF="^UTILITY("_$J_",1,RTN,0," X ^%ZOSF("TEST") Q:'$T  X ^%ZOSF("LOAD") S ^UTILITY($J,1,RTN,0,0)=XCNP-1
 ...
 Q
BEG ;
 S %=INDLC*5 W:$X+10+%>IOM ! W RTN,$J("",16+%-$L(RTN))
